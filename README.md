...
WORKBOARD_CONFIG={"weight_rules": [{"condition": {"repo_org_contains_regex": "my-company"}, "weight_change": 10}, {"condition": {"code_review_title_contains_regex": "^(WIP|wip|Draft)"}, "weight_change": -20}]}
EOF
